...
@Secured("ROLE_ADMIN") // dar privilegios al admin de todos los metodos de la factura
@Controller
...
public class FacturaController {
	...
	public String ver(@PathVariable(value="id") Long id, Model model, RedirectAttributes flash, Locale locale) {
		...
		Factura factura = iClienteService.fetchFacturaByIdWithClienteWithItemFacturaWithProducto(id); //consulta optimizada
	...
	//la Respuesta json la guarda en el response body
